...
<div class="bg-white/[0.03] border border-white/[0.07] rounded-2xl overflow-hidden">
    ...
    <div class="flex items-center gap-3 px-7 pt-5 pb-4
        ...
        <div class="w-[38px] h-[38px] flex-shrink-0 flex items-center justify-center
    ...
    <div class="p-7">
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <select name="category_id"
                            class="field-select w-full bg-white/[0.05] border border-white/[0.07]
                                   rounded-xl px-3 py-2.5 text-[13.5px] text-gray-200 transition-all
                                   {{ $errors->has('category_id') ? 'border-red-700/50 bg-red-950/[0.05]' : '' }}"
                            required>
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <input type="text" name="barcode"
                           class="field-input w-full bg-white/[0.05] border border-white/[0.07]
                                  rounded-xl px-3 py-2.5 text-[13.5px] text-gray-200
                                  placeholder-gray-600 transition-all
                                  {{ $errors->has('barcode') ? 'border-red-700/50 bg-red-950/[0.05]' : '' }}"
                           placeholder="e.g. 8850006151227"
                ...
                <div class="flex flex-col gap-1.5 md:col-span-2">
                    ...
                    <input type="text" name="name"
                           ...
                           placeholder="e.g. Cambodia Cola 330ml"
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" name="cost_price"
                               class="field-input w-full bg-white/[0.05] border border-white/[0.07]
                                      rounded-xl pl-6 pr-3 py-2.5 text-[13.5px] text-gray-200
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <input type="number" name="stock"
                           class="field-input w-full bg-white/[0.05] border border-white/[0.07]
                                  rounded-xl px-3 py-2.5 text-[13.5px] text-gray-200 font-mono transition-all
            ...
            <div class="mb-2">
                ...
                <div id="imagePreview" class="hidden relative mb-3">
                    <img id="previewImg" src="" alt="Preview"
                         class="w-full max-h-[180px] object-cover rounded-xl border border-white/[0.07]">
                    <button type="button" onclick="clearImage()"
                            class="absolute top-2 right-2 bg-red-700/85 hover:bg-red-600
                                   text-white text-[11px] font-bold px-2.5 py-1 rounded-lg
                ...
                {{-- Upload zone --}}
                <div id="uploadArea">
                    <label class="upload-zone flex flex-col items-center justify-content-center gap-2
                                  py-7 px-4 bg-white/[0.03] border-2 border-dashed border-white/10
                                  rounded-xl cursor-pointer text-center transition-all relative">
                        <span class="text-[30px] opacity-45">🖼️</span>
                        <span class="text-[13px] font-semibold text-gray-400">Click to upload image</span>
                        <span class="text-[11px] text-gray-600">JPG, PNG, WEBP — max 2MB</span>
            ...
            {{-- Actions --}}
            <div class="flex items-center justify-end gap-2.5 pt-6 mt-2 border-t border-white/[0.07]">
                <a href="{{ route('admin.products.index') }}"
                   class="px-[18px] py-2.5 rounded-xl text-[13px] font-semibold text-gray-400
                          bg-white/[0.04] border border-white/[0.07] no-underline transition-all
