...
<style>
    ...
    .btn-filter.primary:hover { transform: translateY(-1px); box-shadow: 0 4px 16px rgba(0,48,135,0.4); }
    .btn-filter.ghost {
        background: rgba(255,255,255,0.04);
        border: 1px solid rgba(255,255,255,0.08);
        color: #9CA3AF;
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    @else
                        <span class="payment-badge" style="background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);color:#9CA3AF;">
                            {{ $sale->payment_method }}
                        </span>
                    @endif
                </td>
                ...
                <td>
                    <div style="display:flex;gap:6px;align-items:center;">
                        ...
                        <a href="{{ route('admin.pos.receipt', $sale) }}" target="_blank" class="action-btn action-view" style="background:rgba(22,163,74,0.15);border-color:rgba(22,163,74,0.3);color:#86EFAC;">
                            🖨️ Receipt
                        </a>
