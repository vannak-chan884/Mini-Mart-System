...
@push('styles')
    <style>
        ...
        .btn-add { gap: 7px; padding: 10px 18px; background: linear-gradient(135deg, var(--blue), var(--blue-mid)); border-radius: 10px; font-size: 13px; font-weight: 600; font-family: 'DM Sans', sans-serif; text-decoration: none; transition: all 0.2s; box-shadow: 0 3px 12px rgba(0,48,135,0.35); border: none; cursor: pointer; }
        ...
        thead th { padding: 11px 20px; font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.8px; color: var(--muted); text-align: left; border-bottom: 1px solid var(--border); white-space: nowrap; }
        ...
        .row-num { font-family: 'IBM Plex Mono', monospace; font-size: 12px; color: var(--muted); width: 48px; }
        .cat-icon { width: 34px; height: 34px; border-radius: 9px; background: rgba(0,48,135,0.2); border: 1px solid rgba(0,48,135,0.3); display: flex; align-items: center; justify-content: center; font-size: 15px; flex-shrink: 0; }
        .cat-name { font-weight: 600; font-size: 14px; }
        .action-wrap { display: flex; align-items: center; justify-content: flex-end; gap: 8px; }
        .action-btn { display: inline-flex; align-items: center; gap: 5px; padding: 6px 13px; border-radius: 7px; font-size: 12px; font-weight: 600; font-family: 'DM Sans', sans-serif; text-decoration: none; cursor: pointer; border: 1px solid; transition: all 0.15s; white-space: nowrap; }
        ...
        /* ── Delete Modal ── */
        #deleteModal { display: none; position: fixed; inset: 0; z-index: 1000; align-items: center; justify-content: center; background: rgba(0,0,0,0.55); backdrop-filter: blur(4px); padding: 16px; }
        #deleteModal.open { display: flex; }
        .modal-card { background: #1C1C2E; border: 1px solid rgba(255,255,255,0.09); border-radius: 18px; padding: 28px 28px 24px; width: 100%; max-width: 420px; box-shadow: 0 20px 60px rgba(0,0,0,0.5); animation: modalIn 0.2s ease; }
        @keyframes modalIn { from { opacity:0; transform:scale(0.95) translateY(8px); } to { opacity:1; transform:scale(1) translateY(0); } }
        .modal-icon { width: 48px; height: 48px; border-radius: 14px; background: rgba(204,0,1,0.12); border: 1px solid rgba(204,0,1,0.25); display: flex; align-items: center; justify-content: center; font-size: 22px; margin-bottom: 16px; }
        .modal-title { font-family: 'Playfair Display', serif; font-size: 18px; font-weight: 700; color: #fff; margin-bottom: 8px; }
        .modal-body { font-size: 13.5px; color: #9CA3AF; line-height: 1.6; margin-bottom: 24px; }
        .modal-body strong { color: #E8E4DC; font-weight: 600; }
        .modal-actions { display: flex; gap: 10px; justify-content: flex-end; }
        .btn-cancel { padding: 9px 20px; border-radius: 9px; border: 1px solid rgba(255,255,255,0.1); background: rgba(255,255,255,0.05); color: #9CA3AF; font-size: 13px; font-weight: 600; font-family: 'DM Sans', sans-serif; cursor: pointer; transition: all 0.15s; }
        .btn-cancel:hover { background: rgba(255,255,255,0.09); color: #E8E4DC; }
        .btn-confirm-delete { padding: 9px 20px; border-radius: 9px; border: 1px solid rgba(204,0,1,0.4); background: rgba(204,0,1,0.15); color: #FCA5A5; font-size: 13px; font-weight: 600; font-family: 'DM Sans', sans-serif; cursor: pointer; transition: all 0.15s; }
        .btn-confirm-delete:hover { background: rgba(204,0,1,0.28); border-color: rgba(204,0,1,0.6); color: #fff; }
    </style>
@endpush
