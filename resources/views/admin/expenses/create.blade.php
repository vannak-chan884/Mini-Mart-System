...
@section('content')
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <div>
            <h1 class="font-['Playfair_Display'] text-[20px] font-bold text-[#1A1A2E] dark:text-[#EEEAE2] leading-tight">
                Add Expense
            </h1>
    ...
    <div class="max-w-xl">
        <div
            ...
            <div
                ...
                <div
                    class="w-8 h-8 rounded-[9px] flex items-center justify-center text-base flex-shrink-0
                        bg-[rgba(220,38,38,0.1)] dark:bg-[rgba(220,38,38,0.15)]
            ...
            {{-- Form --}}
            <form method="POST" action="{{ route('admin.expenses.store') }}" class="p-6 space-y-5">
                @csrf
                ...
                <div class="group">
                    ...
                    <div class="relative">
                        ...
                        <select id="category_id" name="category_id"
                            class="w-full pl-10 pr-4 py-2.5 rounded-[10px] appearance-none
                    ...
                    @error('category_id')
                        <p class="mt-1.5 font-['DM_Sans'] text-[11.5px] text-red-500 dark:text-red-400 flex items-center gap-1">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="group">
                        ...
                        @error('amount')
                            <p class="mt-1 font-['DM_Sans'] text-[11px] text-red-500 dark:text-red-400">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="group">
                        ...
                        @error('date')
                            <p class="mt-1 font-['DM_Sans'] text-[11px] text-red-500 dark:text-red-400">{{ $message }}
                            </p>
                        @enderror
                    </div>
                ...
                <div class="group">
                    <label for="note"
                        class="block font-['DM_Sans'] text-[11px] font-bold uppercase tracking-[0.8px] mb-1.5
                           ...
                           transition-colors duration-200">
                        Note
                        <span class="normal-case tracking-normal font-normal text-[#D1D5DB] dark:text-[#374151] ml-1">
                            (optional)
                        </span>
                    </label>
                    <textarea id="note" name="note" rows="3" placeholder="Any additional details…"
                        class="w-full px-4 py-2.5 rounded-[10px] resize-none
                                 ...
                                 outline-none transition-all duration-200
                                 focus:border-[rgba(59,130,246,0.5)] focus:bg-[rgba(59,130,246,0.04)]
                                 focus:shadow-[0_0_0_3px_rgba(59,130,246,0.1)]">{{ old('note') }}</textarea>
                </div>
